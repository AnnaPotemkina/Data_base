...
from exhibition_insrtion import MATERIAL_DIFF, OWNER, GENRES

def other_insertion(connection, number=300):
    ...
    for _ in range(number):
        ...
        cur.execute(
            f"INSERT INTO other (owners, year_creation, material, artist, exhibition)"
